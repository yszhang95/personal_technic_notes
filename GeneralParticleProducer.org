...
**** =pat::GenericParticleRef addParticle(const pat::GenericParticle& particle)=
  ...
  if (particle.hasUserData("primaryVertex")) {
    ...
    priVtx = getVertexRef(*priVtx);
     ...
     #+END_EXAMPLE
**** TODO =void matchPrimaryVertex(pat::GenericParticle& cand, const TransTrackColl& tracks={}, FreeTrajectoryState fts={}, const double& thr=1.E-9)=
...
**** TODO =void swapDaughters(DoubleMap& swapDauColls, const pat::GenericParticle& cand, const pat::GenericParticleCollection& dauColl)=
